...
const Hero = () => {
    return (
        <div className='md:flex justify-between relative md:h-[90vh] items-center overflow-hidden' >
            ...
            <div className="hero-content z-10">
                ...
                <h1 className='text-[52px] font-bold leading-tight'>Miguel <br /> Brito</h1>
                <p className='text-sec-text py-5'>Full-Stack Developer · Back-end Specialized</p>
                <div className="absolute top-0 py-5 w-full justify-center md:static md:justify-start social flex space-x-4">
            ...
            <div className="hero-links z-10">
                <button className='flex space-x-2 items-center resumeButton text-second font-bold p-2 text-xl'><Link>Resume</Link> <span><FaArrowRight></FaArrowRight></span></button>
