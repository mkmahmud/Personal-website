...
const Contact = () => {
  ...
  const handleSubmit = (event) => {
    ...
    fetch(
      "https://portfolio-backend-mahmudulmk4-gmailcom.vercel.app/api/v1/p/message/create-message",
      {
        method: "post",
        headers: {
  ...
  return (
    <div className="my-24" id="Contact">
      ...
      <div className="mx-auto w-full ">
        <form
          className="text-center w-[360px] md:w-[500px] text-text mx-auto "
        ...
        >
          <div className="my-4 ">
            ...
            <input
              ...
              className="bg-sec-bg border border-second h-[41px] rounded-lg w-[291px] md:w-[371px] outline-0 px-4"
              name="name"
              id=""
            />
          </div>
          ...
          <div className="my-4">
            ...
            <textarea
              ...
              value={state.message}
              onChange={handleInputChange}
              className="bg-sec-bg border border-second h-[141px] rounded-lg w-[291px] md:w-[371px] outline-0 px-4"
              id=""
              cols="30"
              rows="20"
            ></textarea>
          ...
          <button
            type="submit"
            className="bg-second px-3.5 py-2.5 rounded-lg text-sm text-white"
          >
            Submit Message
          </button>
        </form>
